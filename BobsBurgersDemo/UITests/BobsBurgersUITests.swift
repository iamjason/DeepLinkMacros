...
final class BobsBurgersNavigationUITests: XCTestCase {
    ...
    func testMenuTabNavigationToBurgerOfTheDay() throws {
        // Find and tap Burger of the Day in the list
        let burgerOfTheDayCell = app.cells.staticTexts["Burger of the Day"]
        XCTAssertTrue(burgerOfTheDayCell.waitForExistence(timeout: 2))
        burgerOfTheDayCell.tap()
    ...
    func testFamilyTabNavigationToFriends() throws {
        ...
        let friendsCell = app.cells.staticTexts["Friends"]
        XCTAssertTrue(friendsCell.waitForExistence(timeout: 2))
        friendsCell.tap()
